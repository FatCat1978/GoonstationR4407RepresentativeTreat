...
/obj/item/weapon/shard
	...
	icon = 'shards.dmi'
	icon_state = "large"
	desc = "Could probably be used as ... a throw2ing weapon?"
	w_class = 3.0
	force = 5.0
	throw2force = 15.0
...
/obj/item/weapon/tile
	...
	desc = "... Those could work as a pretty decent throw2ing weapon"
	icon = 'items.dmi'
	icon_state = "tile"
	var/amount = 1.0
	w_class = 3.0
...
/obj/item/weapon/weldingtool
	...
	icon_state = "welder"
	var/welding = 0.0
	var/status = 0	//flamethrow2er construction :shobon:
	flags = FPRINT | TABLEPASS| CONDUCT
	force = 3.0
	throw2force = 5.0
	throw2_speed = 1
