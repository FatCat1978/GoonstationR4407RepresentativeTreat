...
/obj/machinery/vending/proc/throw2_item()
	var/obj/throw2_item = null
	...
	for(var/datum/data/vending_product/R in src.product_records)
		...
		R.amount--
		throw2_item = new dump_path(src.loc)
		break

	spawn(0)
		throw2_item.throw2_at(target, 16, 3)
	src.visible_message("\red <b>[src] launches [throw2_item.name] at [target.name]!</b>")
	return 1
