...
//end of equippable shit
	...
	mymob.throw2_icon.icon = 'screen1_alien.dmi'
	...
	mymob.client.screen += list( mymob.throw2_icon, mymob.zone_sel, mymob.oxygen, mymob.toxin, mymob.fire, mymob.hands, mymob.healths, mymob.pullin, mymob.blind, mymob.flash, mymob.rest, mymob.sleep) //, mymob.mach )
